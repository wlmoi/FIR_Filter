...
HD_PWD='D:/FIR_Filter/HardwareCompare/HardwareCompare.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log tb_fir_direct_form.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source tb_fir_direct_form.tcl
